 ...
 * <li>{@link BusinessDefaultNode}: statistics for specific resource name in the specific context.</li>
...
public class BusinessStatisticSlot extends AbstractLinkedProcessorSlot<BusinessDefaultNode> {
