...
import com.alibaba.csp.sentinel.node.BusinessDefaultNode;
...
public class BusinessFlowSlot extends AbstractLinkedProcessorSlot<BusinessDefaultNode> {

    private final FlowRuleChecker checker;

    public BusinessFlowSlot() {
     ...
     * @since 1.6.1
     */
    BusinessFlowSlot(FlowRuleChecker checker) {
        AssertUtil.notNull(checker, "flow checker should not be null");
        this.checker = checker;
    }

    @Override
    public void entry(Context context, ResourceWrapper resourceWrapper, BusinessDefaultNode node, int count,
...
//        checkFlow(resourceWrapper, context, node, count, prioritized);
    ...
    void checkFlow(ResourceWrapper resource, Context context, BusinessDefaultNode node, int count, boolean prioritized)
